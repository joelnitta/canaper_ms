...
`vegan` includes by far the greatest number of algorithms for generating random communities and is used by `canaper`.
...
ggsave(plot = fig, file = here::here("ms/figure_3.pdf"),
