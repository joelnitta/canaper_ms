...
As of writing, `PhyloMeasures` and `EcoSimR` have both been removed from CRAN and may not be currently maintained.
...
`canaper` source code is available on GitHub (<https://github.com/ropensci/canaper>) and Zenodo (<https://doi.org/10.5281/zenodo.5094032>).
Usage of `canaper` is documented at <https://docs.ropensci.org/canaper/>.
Code and data used to run analyses and generate this manuscript available at <https://github.com/joelnitta/canaper_ms>.
